...
-- CreateEnum
CREATE TYPE "Track" AS ENUM ('new', 'exp', 'review');
...
-- CreateIndex
CREATE UNIQUE INDEX "LearningPathLesson_unitId_lessonId_key" ON "LearningPathLesson"("unitId", "lessonId");
...
-- AddForeignKey
ALTER TABLE "LearningPath" ADD CONSTRAINT "LearningPath_levelId_fkey" FOREIGN KEY ("levelId") REFERENCES "CourseLevel"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LearningPathUnit" ADD CONSTRAINT "LearningPathUnit_pathId_fkey" FOREIGN KEY ("pathId") REFERENCES "LearningPath"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LearningPathLesson" ADD CONSTRAINT "LearningPathLesson_unitId_fkey" FOREIGN KEY ("unitId") REFERENCES "LearningPathUnit"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LearningPathLesson" ADD CONSTRAINT "LearningPathLesson_lessonId_fkey" FOREIGN KEY ("lessonId") REFERENCES "Lesson"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "MockTest" ADD CONSTRAINT "MockTest_levelId_fkey" FOREIGN KEY ("levelId") REFERENCES "CourseLevel"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "UserEnrollment" ADD CONSTRAINT "UserEnrollment_pathId_fkey" FOREIGN KEY ("pathId") REFERENCES "LearningPath"("id") ON DELETE SET NULL ON UPDATE CASCADE;
